...
public class BListTriClusterInstantiator : MonoBehaviour
{
...
We do need them in order for later for calculating formations
    ...
    /* I think arrays go x,y but when put them in x,s are down y,s across so this is out by 90 degs.
     * think of it as row column
    public Color[,] triDataAr = new Color[,]{ 
        { Color.red,Color.blue, Color.blue,Color.green, Color.blue, Color.blue,Color.red},
        { Color.blue,Color.blue, Color.blue,Color.green, Color.blue, Color.blue,Color.blue}
    };                                                                                
    */
   ...
   //     Debug.Log(this + " is making a BList container");
       ...
       BListTriCluster containerScript = container.GetComponent<BListTriCluster>();

        containerScript.badTriDataTC = triDataAr;//here give the instructions to containerScript how to build itself
